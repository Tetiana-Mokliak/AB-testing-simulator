...
У папці `prototype/stepup-a-b-simulator (2)` знаходиться вихідний код веб-прототипу симулятора, створеного в Google AI Studio.

Саме цей прототип використовувався для генерації синтетичних датасетів, які аналізуються у сценаріях проєкту.

Для запуску локально використовуйте інструкцію з README всередині папки prototype.
